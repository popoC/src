...
int showHelp(Mat img,int co){
  ...
  putText(img,"Press 1 key: /set back" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 2 key: /set front" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 3 key: /set back_m2" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 4 key: /set front_m2" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 5 key: /set back_down" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 6 key: /set back_up" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 7 key: /set front_down" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 9 key: /auto run" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
  putText(img,"Press 0 key: /go bottom" ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
      ...
      switch(go_step){
        ...
        case 3:
            ...
            if(wait_sleep > 20){
                ...
                fp = fopen("/home/po/mouse_set_conf.txt","w");
...
int main(int argc, char **argv)
{
      ...
      move_y_scale = 1.0;
        ...
        fp = fopen("/home/po/mouse_set_conf.txt","r");
