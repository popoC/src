...
int showHelp(Mat img,int co){
  ...
  putText(img,"Press w key: save to /home/tori/Npget.jpg " ,Point(20,show_index+=30),  FONT_HERSHEY_COMPLEX_SMALL , 1,cv::Scalar(0,200,100));
...
*/
  ...
  case 'w':
      ...
      strftime(file_name_buff,80,"/home/tori/image/%m_%d_%H_%M_%S.jpg", now);
